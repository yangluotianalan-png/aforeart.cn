...
const systemPlan = [
  ...
  s("2070150021", "自然辩证法概论", 1, 18, "公共必修课", "必修课", "政治理论类", "春"),
  s("2070310013", "新时代中国特色社会主义理论与实践", 2, 36, "公共必修课", "必修课", "政治理论类", "秋"),
  s("2070330311", "习近平新时代中国特色社会主义思想研究（硕士）", 2, 32, "公共必修课", "必修课", "政治理论类", "秋"),
  ...
  s("2900010043", "学术活动", 0.5, 8, "公共必修课", "必修课", "培养过程类", "秋、春"),
...
function collectDiffs() {
  const diffs = [
    { code: "毕业总学分", text: `Word 写明总学分不少于 32，系统截图显示总学分最低 ${systemRules.totalMin}。页面右侧仍按 Word 拆分显示，同时保留这条系统差异提醒。` },
    { code: "公共选修", text: `Word 要求 1 学分，系统截图显示公共选修课最低 ${systemRules.publicElective} 学分。若最终以系统提交为准，需要公共选修选到 2 学分。` },
    { code: "学术活动", text: "Word 为 2900010033，1 学分；系统截图为 2900010043，0.5 学分，代码和学分均不同。" },
